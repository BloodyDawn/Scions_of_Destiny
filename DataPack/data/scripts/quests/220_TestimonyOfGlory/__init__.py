...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st) :
    ...
    # Everything bellow here is for condition 4 and 5
          ...
          st.addSpawn(5080,80117,120039,-2259)
          st.addSpawn(5081,80058,120038,-2259)
          st.giveItems(GLOVE_OF_VOLTAR,1)
          st.takeItems(MANAKIAS_LETTER1,1)
    elif event == "7616-04.htm" :                           # Chief of Enku Orcs
          st.playSound("Itemsound.quest_before_battle")
          st.addSpawn(5082,17710,189813,-3581)
          st.addSpawn(5082,17674,189798,-3581)
          st.addSpawn(5082,17770,189852,-3581)
          st.addSpawn(5082,17803,189873,-3581)
          st.giveItems(GLOVE_OF_KEPRA,1)
          st.takeItems(MANAKIAS_LETTER2,1)
    elif event == "7617-04.htm" :                           # Chief of Turek Orcs
          st.playSound("Itemsound.quest_before_battle")
          st.addSpawn(5083,-94292,110781,-3701)
          st.addSpawn(5083,-94293,110861,-3701)
 ...
 def onKill (self,npc,player,isPet):
   st = player.getQuestState("220_TestimonyOfGlory")
   if st :
    ...
    if cond == 1 and npcId in DROPLIST_COND_1.keys():
     ...
     if npcId in [ 778, 779 ] :
       st.playSound("Itemsound.quest_before_battle")
       #st.addSpawn(5086)
       st.addSpawn(5086, 11839,-106261,-3550,300000)
       return "Revenant of Tantos Chief has spawned at X=11839 Y=-106261 Z=-3550"
       # Alternate coord. set:
       #st.addSpawn(5086,11567,-106785,-3520)
     elif npcId == 5086 :
...
QUEST.addTalkId(7514)
QUEST.addTalkId(7515)
QUEST.addTalkId(7565)
QUEST.addTalkId(7571)
QUEST.addTalkId(7615)
QUEST.addTalkId(7616)
QUEST.addTalkId(7617)
QUEST.addTalkId(7618)
QUEST.addTalkId(7619)
QUEST.addTalkId(7642)

...
#This Put all Mob Ids from dictionary in a list. So its possible to add new mobs, to one of this 4 Areas, without modification on the addKill Part.
import sys
...
class Quest (JQuest) :
	...
	def onKill (self,npc,player,isPet):
            st = player.getQuestState("333_BlackLionHunt")
            if st :

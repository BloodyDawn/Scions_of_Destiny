...
Droplist = {
    ...
    947 : 16, #Connabi
    635 : 15, #Carinkain
    773 : 61, #Conjurer Bat Lord
    774 : 60, #Conjurer Bat
    760 : 24, #Dragon Bearer Archer
    758 : 24, #Dragon Bearer Chief
    759 : 23, #Dragon Bearer Warrior
    242 : 22, #Dustwind Gargoyle
    281 : 22, #Dustwind Gargoyle (2)
    556 : 14, #Giant Monstereye
    668 : 21, #Grave Guard
    241 : 22, #Hunter Gargoyle
    286 : 22, #Hunter Gargoyle (2)
    950 : 20, #Innersen
    949 : 19, #Luminun
    942 : 9,  #Nightmare Guide
    943 : 12, #Nightmare Keeper
    944 : 11, #Nightmare Lord
    559 : 14, #Rotting Golem
    243 : 21, #Thunder Wyrm
    282 : 21, #Thunder Wyrm (2)
    677 : 34, #Tulben
    605 : 15, #Weird Drake
}
...
QUEST = Quest(384,qn,"Warehouse Keepers Pastime") 

...
#Mobs
Breka_Orc_Warrior = 271
Windsus = 553
Tarlk_Bugbear_Warrior = 571
Gremlin_Filcher = 5149
Mobs = [Breka_Orc_Warrior, Windsus, Tarlk_Bugbear_Warrior, Gremlin_Filcher]
Lizardmen = [578,579,581,582,641,642,643]

#Droplist Format- npcId:[itemId,itemAmount,chance]
Level_1 = {
    550 : [3709,40,75], #Gaurdian Basilisk
    581 : [3710,20,50], #Leto Lizardman Shaman
    5140 : [3711,1,100], #Breka Overlord Haka
    5141 : [3712,1,100], #Breka Overlord Jaka
    5142 : [3713,1,100], #Breka Overlord Marka
    5143 : [3714,1,100], #Windsus Aleph
    563 : [3715,20,50], #Manashen Gargoyle
    565 : [3715,20,50], #Enchanted Stone Golemn
    555 : [3716,30,70], #Giant Fungus
    }
Level_2 = {
    586 : [3717,20,50],   #Timak Orc Warrior
    560 : [3718,20,50],   #Trisalim Spider
    561 : [3718,20,50],   #Trisalim Tarantula
    591 : [3719,30,100],  #Valley Treant
    597 : [3719,30,100],  #Valley Treant Elder
    675 : [3720,20,50],   #Tairim
    660 : [3721,20,50],   #Archer of Greed
    5144 : [3722,1,100],   #Tarlk Raider Athu
    5145 : [3723,1,100],   #Tarlk Raider Lanka
    5146 : [3724,1,100],   #Tarlk Raider Triska
    5147 : [3725,1,100],   #Tarlk Raider Motura
    5148 : [3726,1,100],   #Tarlk Raider Kalath
    }
...
Tor_requests_1 = {
    578 : [3727,3769,'1',40,80],  #Leto Lizardman Archer
    579 : [3727,3769,'1',40,83],  #Leto Lizardman Soldier
    586 : [3728,3770,'1',50,89],  #Timak Orc Warrior
    588 : [3728,3770,'1',50,100], #Timak Orc Overlord
    565 : [3729,3771,'1',50,100], #Enchanted Stone Golem
    556 : [3730,3772,'1',30,50],  #Giant Monster Eye
    557 : [3731,3773,'1',40,80],  #Dire Wyrm
    550 : [3732,3774,'Rnd.get(2) + 1',100,100], #Guardian Basilisk
    552 : [3733,3775,'1',50,100], #Fettered Soul
    553 : [3734,3776,'1',30,50],  #Windsus
    554 : [3735,3777,'2',100,100],#Grandis
    631 : [3736,3778,'1',50,100], #Taik Orc Archer
    632 : [3736,3778,'1',50,93],  #Taik Orc Warrior
    600 : [3737,3779,'1',30,50],  #Karul Bugbear
    601 : [3738,3780,'1',40,62],  #Tamlin Orc
    602 : [3738,3780,'1',40,80],  #Tamlin Orc Archer
    5157 : [3739,3781,'1',1,100],  #Leto Chief Narak
    567 : [3740,3782,'1',50,50],  #Enchanted Gargoyle
    269 : [3741,3783,'1',50,93],  #Breka Orc Shaman
    271 : [3741,3783,'1',50,100], #Breka Orc Warrior
    5156 : [3742,3784,'1',1,100],  #Leto Shaman Ketz
    5158 : [3743,3785,'1',1,100],  #Timak Raider Kaikee
    603 : [3744,3786,'1',30,50],  #Kronbe Spider
    5160 : [3746,3788,'1',1,100],  #Gok Magok
    5164 : [3747,3789,'1',1,100]   #Karul Chief Orooto
    }

#Droplist Format- npcId : [itemRequired,itemGive,itemAmount,chance]
Tor_requests_2 = {
    560 : [3749,3791,40,66],  #Trisalim Spider
    561 : [3749,3791,40,75],  #Trisalim Tarantula
    633 : [3750,3792,50,53],  #Taik Orc Shaman
    634 : [3750,3792,50,99],  #Taik Orc Captain
    641 : [3751,3793,40,88],  #Harit Lizardman Grunt
    642 : [3751,3793,40,88],  #Harit Lizardman Archer
    643 : [3751,3793,40,91],  #Harit Lizardman Warrior
    661 : [3752,3794,20,50],  #Hatar Ratman Thief
    662 : [3752,3794,20,52],  #Hatar Ratman Boss
    667 : [3753,3795,30,90],  #Farcran
    589 : [3754,3796,40,49],  #Fline
    590 : [3755,3797,40,51],  #Liele
    592 : [3756,3798,40,80],  #Satyr
    598 : [3756,3798,40,100], #Satyr Elder
    682 : [3758,3800,30,70],  #Vanor Silenos Grunt
    683 : [3758,3800,30,85],  #Vanor Silenos Scout
    684 : [3758,3800,30,90],  #Vanor Silenos Warrior
    571 : [3759,3801,30,63],  #Tarlk Bugbear Warrior
    5159 : [3760,3802,1,100],  #Timak Overlord Okun
    5161 : [3761,3803,1,100],  #Taik Overlord Kakran
    639 : [3762,3804,40,86],  #Mirror
    664 : [3763,3805,20,77],  #Deprive
    593 : [3764,3806,20,68],  #Unicorn
    599 : [3764,3806,20,86],  #Unicorn Elder
    5163 : [3765,3807,1,100],  #Vanor Elder Kerunos
    659 : [3766,3808,20,73],  #Grave Wanderer
    5162 : [3767,3809,1,100],  #Hatar Chieftain Kubel
    676 : [3768,3810,10,64]   #Judge of Marsh
    }
...
Tor_requests_tospawn = {
    582 : [3739,3781,7157],  #Leto Lizardman Overlord
    581 : [3742,3784,7156],  #Leto Lizardman Shaman
    586 : [3743,3785,7158],  #Timak Orc Warrior
    554 : [3746,3788,7160],  #Grandis
#level 2
    588 : [3760,3802,7159],   #Timak Orc Overlord
    634 : [3761,3803,7161],   #Tiak Orc Captain
    686 : [3765,3807,7163],   #Vanor Silenos Chieftan
    662 : [3767,3809,7162]    #Hatar Ratman Boss
    }
            ...
            if instructions_2 :
                ...
                if rand < chance and st.getQuestItemsCount(req) and st.getQuestItemsCount(give) < amount :
                    ...
                    if st.getQuestItemsCount(give) >= amount :
                        ...
                        st.playSound("ItemSound.quest_itemget")
                    if npcId in [5160,5164] and Rnd.get(2) :
                        st.addSpawn(5150,300000)
                        st.addSpawn(5150,300000)
                ...
                if st.getQuestItemsCount(req) and st.getQuestItemsCount(give) < amount :
                    if rand < chance :
                        ...
                        if st.getQuestItemsCount(give) >= amount :
                            ...
                            st.playSound("ItemSound.quest_itemget")
                        if npcId == 5162 and Rnd.get(2) :
                            st.addSpawn(5150,300000)
                            st.addSpawn(5150,300000)
                            AutoChat(npc,"We will destroy the legacy of the ancient empire!")
                    if npcId in [661,662,589,590,639] and not Rnd.get(20) :

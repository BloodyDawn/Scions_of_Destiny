    ...
    * diff = -8 (mob is 8 levels below), XP bonus rate = 0.4, SP bonus rate = 0.16 */
    ...
    public static void load()
    {
        if (Server.SERVER_MODE == Server.MODE_GAMESERVER)
        {
            ...
            String str = optionsSettings.getProperty("EnableFallingDamage", "auto");
    ...
    public static boolean setParameterValue(String pName, String pValue)
    {
        ...
        else if (pName.equalsIgnoreCase("RateBossDropItems")) RATE_BOSS_DROP_ITEMS = Float.parseFloat(pValue);
        ...
        else if (pName.equalsIgnoreCase("AllowL2Walker")) ALLOW_L2WALKER = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AllowManor")) ALLOW_MANOR = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AllowNpcWalkers")) ALLOW_NPC_WALKERS = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AllowPetWalkers")) ALLOW_PET_WALKERS = Boolean.valueOf(pValue);
        ...
        else if (pName.equalsIgnoreCase("BlessedEnchantChanceWeapon")) BLESSED_ENCHANT_CHANCE_WEAPON = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("BlessedEnchantChanceArmor")) BLESSED_ENCHANT_CHANCE_ARMOR = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("BlessedEnchantChanceJewelry")) BLESSED_ENCHANT_CHANCE_JEWELRY = Integer.parseInt(pValue);
        ...
        else if (pName.equalsIgnoreCase("StartingSubclassLevel")) STARTING_SUB_LEVEL = Byte.parseByte(pValue);
        ...
        else if (pName.equalsIgnoreCase("AutoLearnSkills")) AUTO_LEARN_SKILLS = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AutoLearn3rdClassSkills")) AUTO_LEARN_3RD_SKILLS = Boolean.valueOf(pValue);
        ...
        else if (pName.equalsIgnoreCase("AltMobAggroInPeaceZone")) ALT_MOB_AGGRO_IN_PEACEZONE = Boolean.valueOf(pValue);
        ...
        else if (pName.equalsIgnoreCase("AllowEntireTree")) ALLOW_ENTIRE_TREE = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AlternateClassMaster")) ALTERNATE_CLASS_MASTER = Boolean.valueOf(pValue);
        ...
        else if (pName.equalsIgnoreCase("EnchantSkillSpBookNeeded")) ES_SP_BOOK_NEEDED = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AutoLoot")) AUTO_LOOT = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AutoLootRaids")) AUTO_LOOT_RAIDS = Boolean.valueOf(pValue);
        ...
        else if (pName.equalsIgnoreCase("AltMaxSubClasses")) ALT_MAX_SUBCLASS = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("AltSubClassWithoutQuests")) ALT_GAME_SUBCLASS_WITHOUT_QUESTS = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("AltEnableTutorial")) ALT_ENABLE_TUTORIAL = Boolean.valueOf(pValue);
        ...
        else if (pName.equalsIgnoreCase("ChampionPassive")) CHAMPION_PASSIVE = Boolean.valueOf(pValue);
        else if (pName.equalsIgnoreCase("ChampionFrequency")) CHAMPION_FREQUENCY = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("ChampionTitle")) CHAMPION_TITLE = pValue;
        ...
        else if (pName.equalsIgnoreCase("ChampionRewardLowerLvlItemChance")) CHAMPION_REWARD_LOWER_CHANCE = Integer.parseInt(pValue);
        else if (pName.equalsIgnoreCase("ChampionRewardHigherLvlItemChance")) CHAMPION_REWARD_HIGHER_CHANCE = Integer.parseInt(pValue);

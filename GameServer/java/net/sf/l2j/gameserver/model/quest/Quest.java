...
public class Quest extends ManagedScript
{
    ...
    /**
     * Add this quest to the list of quests that the passed npc will respond to for Creature-See Events.<BR><BR>
     * @param talkId : ID of the NPC
     * @return int : ID of the NPC
     */
    ...
    public boolean unload()
    {
        ...
        // be restarted).
        for (FastList<QuestTimer> timers : allEventTimers.values())
        {
            for (QuestTimer timer : timers)
                timer.cancel();
        }

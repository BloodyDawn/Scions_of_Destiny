...
public abstract class L2ZoneType
{
    ...
    protected FastMap<Integer, L2ZoneForm> _zone;
     ...
     * @param zone
     */
    public void setZone(int id, L2ZoneForm zone)
    {
        getZones().put(id, zone);
    }
    ...
    {
        for (L2ZoneForm zone : getZones().values())
            return zone;

        return null;
    }

    public final FastMap<Integer, L2ZoneForm> getZones()
    {
        if (_zone == null)
            _zone = new FastMap<Integer, L2ZoneForm>().shared();
        return _zone;
    }

...
public class Siege
{
    ...
    {
        if (player.getClan() == null || player.getClan().getHasCastle() == getCastle().getCastleId()
            || !SiegeManager.getInstance().checkIsRegistered(player.getClan(), getCastle().getCastleId()))
            return;

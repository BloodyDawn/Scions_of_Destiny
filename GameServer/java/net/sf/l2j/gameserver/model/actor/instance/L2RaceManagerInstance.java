...
public class L2RaceManagerInstance extends L2NpcInstance
{
    ...
    public L2RaceManagerInstance(int objectId, L2NpcTemplate template)
    {
        ...
        if (notInitialized)
        {
            ...
            s.scheduleGeneralAtFixedRate(new Announcement(SystemMessage.MONSRACE_TICKETS_AVAILABLE_FOR_S1_RACE),
                                         0, 10 * MINUTE);
            ...
            s.scheduleGeneralAtFixedRate(new Announcement(SystemMessage.MONSRACE_COUNTDOWN_IN_FIVE_SECONDS),

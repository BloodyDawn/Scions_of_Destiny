    ...
    public boolean addKnownObject(L2Object object, L2Character dropper)
    {
        ...
        else
        {
            ...
            else if (object instanceof L2PcInstance)
            {
                ...
                {
                    if (getActiveChar().getNetConnection() != null && otherPlayer.getNetConnection() != null)
                    {
                        String ip1 = getActiveChar().getNetConnection().getIP();
                        String ip2 = otherPlayer.getNetConnection().getIP();
                        if (ip1 != null && ip2 != null && ip1.equals(ip2))
                        {
                            getActiveChar().closeNetConnection();
                            return false;
                        }
                    }
                }

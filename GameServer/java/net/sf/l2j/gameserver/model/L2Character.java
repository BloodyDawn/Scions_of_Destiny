...
public abstract class L2Character extends L2Object
{
     ...
     *
     */
    public void broadcastPacket(ServerBasePacket mov)
    {
    ...
    protected void doAttack(L2Character target)
    {
        ...
        _attackTimeToMove = GameTimeController.getGameTicks();
        _attackTimeToMove += (timeAtk / GameTimeController.MILLIS_IN_TICK);
        _attackTimeToMove -= 1;
        ...
        ThreadPoolManager.getInstance().scheduleAi(new Runnable()
        {
            public void run()
            {
                // this is the end of this attack
	...
	public void doCast(L2Skill skill)
	{
		...
		// Send a Server->Client packet MagicSkillUser with target, displayId, level, hitTime, reuseDelay
		// to the L2Character AND to all L2PcInstance in the _KnownPlayers of the L2Character
	...
	public boolean doDie(L2Character killer)
	{
		...
		// Stop all active skills effects in progress on the L2Character,
                ...
                if (keepEffects)
                {
                        ...
                        if (((L2PlayableInstance)this).getCharmOfLuck()) //remove Lucky Charm if player has Nobless blessing buff
		...
		if (!isTeleporting())
		{
			setIsPendingRevive(false);
                        ...
                        if (this instanceof L2PcInstance && ((L2PcInstance)this).getEventTeam() > 0)
                        {
                                ...
                                ChangeWaitType revive = new ChangeWaitType(((L2PcInstance)this), ChangeWaitType.WT_STOP_FAKEDEATH);
	...
	{
		if (_AttackByList == null) _AttackByList = new FastList<>();
	...
	public final boolean isAttackingDisabled() { return isStunned() || isSleeping() || _isAttackingNow || isAlikeDead() || isParalyzed() || isCoreAIDisabled(); }
	...
	public boolean isMovementDisabled() { return isStunned() || isRooted() || isSleeping() || isOverloaded() || isParalyzed() || isImmobilized() || isAlikeDead() || isTeleporting(); }
	...
	public final boolean isPendingRevive() { return _IsPendingRevive; }
	...
	public final void setIsTeleporting(boolean value) { _IsTeleporting = value; }
        ...
        public void setIsInvul(boolean value){_IsInvul = value;}
			...
			if (_stackedEffects == null)
                ...
                synchronized(_effects)
                {
                        ...
                        for (L2Effect e : _effects)
                        {
                                ...
                                if (e.getEffectType() == newEffect.getEffectType()
                                ...
                                for (L2Effect e : _effects)
                                {
                                        if (e != null)
                                        {
                                                ...
                                                if (!e.getSkill().isToggle()
                                                     && !e.getSkill().isOffensive()
                                                     && (!(skillid > 4363  && skillid < 4367)))
                                                        pos++;
                                        }
                                        else
                                                break;
	...
	public final void startMuted()
	{
        ...
        /**
         * Active the abnormal effect Physical_Muted flag, notify the L2Character AI and send Server->Client UserInfo/CharInfo packet.<BR><BR>
         */
	...
	public final void startStunning()
	{
        ...
        /**
	 * Launch a Paralyze Abnormal Effect on the L2Character.<BR><BR>
	 *
	 * <B><U> Actions</U> :</B><BR><BR>
	 ...
	 * <li>If Paralyze NOT succeed, send a system message Failed to the L2PcInstance attacker</li><BR><BR>
	 *
	 */
	...
	/**
	 * Stop and remove the L2Effect corresponding to the L2Skill Identifier and update client magic icon.<BR><BR>
	 *
	 * <B><U> Concept</U> :</B><BR><BR>
	 * All active skills effects in progress on the L2Character are identified in ConcurrentHashMap(Integer,L2Effect) <B>_effects</B>.
	 * The Integer key of _effects is the L2Skill Identifier that has created the L2Effect.<BR><BR>
	...
	public final void stopStunning(L2Effect effect)
	{
        ...
        /**
	 * Stop a specified/all Paralyze abnormal L2Effect.<BR><BR>
	 *
	 * <B><U> Actions</U> :</B><BR><BR>
	 ...
	 * <li> Server Packet : CharInfo, NpcInfo, UserInfo...</li><BR><BR>
	 */
	...
	public boolean isAttackingNow()
	{
        ...
        public boolean isMovementDisabledByAttack()
        {
	...
	protected void moveToLocation(int x, int y, int z, int offset)
	{
		...
		if (Config.GEODATA > 0 && !isFlying() // currently flying characters not checked
                    ...
                    && !(this instanceof L2BoatInstance)
                    && (!isInsideZone(ZONE_WATER) || isInsideZone(ZONE_SIEGE))) // swimming also not checked - but distance is limited
		{
			...
			// Movement checks:
                        ...
                        if ((Config.GEODATA == 2 && !(this instanceof L2Attackable && ((L2Attackable)this).isReturningToSpawnPoint()))
                                ...
                                || (this instanceof L2Summon && !(getAI().getIntention() == CtrlIntention.AI_INTENTION_FOLLOW))) // assuming intention_follow only when following owner
			{
                                if (isOnGeodataPath())
                                {
                                        try
                        ...
                        if (Config.GEODATA == 2 && originalDistance-distance > 30 && distance < 2000 && !isAfraid())
			{
                                ...
                                if ((this instanceof L2PlayableInstance && !isInBoat) || isInCombat() || this instanceof L2MinionInstance)
                                {
                                        ...
                                        if (m.geoPath == null || m.geoPath.size() < 2) // No path found
                                        {
                                                ...
                                                if (this instanceof L2PcInstance || (!(this instanceof L2PlayableInstance)
    ...
    /**
     * Check if this object is inside the given radius around the given point. Warning: doesn't cover collision radius!<BR><BR>
     * 
     * @param x   X position of the target
     * @param y   Y position of the target
     * @param z   Z position of the target
	...
	{
		return isInsidePeaceZone((L2Object)attacker, this);
	}
	...
	public final L2Skill getKnownSkill(int skillId)
	{
        ...
        public int getBuffCount()
        {
                ...
                for (L2Effect e : effects)
                {
                        ...
                        if (e.getShowIcon() && (e.getSkill().getSkillType() == L2Skill.SkillType.BUFF ||
                        e.getSkill().isOffensive() ||
         ...
         *
         * @param newEffect Is the effect that is being applied.
         */
	...
	public void onMagicLaunchedTimer(L2Object[] targets, L2Skill skill, int coolTime, boolean instant)
	{
        ...
        public void onMagicFinalizer(L2Object[] targets, L2Skill skill)
        {
                ...
                if (getAI().getNextIntention() == null && (skill.getSkillType() == SkillType.PDAM || skill.getSkillType() == SkillType.FATAL
                    || skill.getSkillType() == SkillType.BLOW || skill.getSkillType() == SkillType.CHARGEDAM || skill.getSkillType() == SkillType.STUN || skill.getSkillType() == SkillType.DRAIN_SOUL || skill.getSkillType() == SkillType.SPOIL || skill.getSkillType() == SkillType.SOW
                    || this instanceof L2Summon && skill.isOffensive()))
                {
    ...
    public void callSkill(L2Skill skill, L2Object[] targets)
    {
        try
        {
                    ...
                    if (activeChar != null)
                    {
                        ...
                        else
                        {
                            if (targetPlayer instanceof L2PcInstance)
                            {
                                ...
                                if (!(targetPlayer.equals(this) || targetPlayer.equals(activeChar)) &&
                                        (((L2PcInstance)targetPlayer).getPvpFlag() > 0 ||
                                        ((L2PcInstance)targetPlayer).getKarma() > 0))
            ...
            L2PcInstance caster = getActingPlayer();
            if (caster != null)
            {
                for (L2Character cha : caster.getKnownList().getKnownCharactersInRadius(1000))
                {
                    if (cha == null)
                        continue;
                    ...
                    if (skill.hasAggro())
                    {
                        ...
                        {
                            L2Attackable mob = (L2Attackable)cha;

...
//         if (drop.getItemId() == 57 && dropChance > L2DropData.MAX_CHANCE) dropChance = L2DropData.MAX_CHANCE; // If item is adena, dont drop multiple time
     ...
     /**
      * Manage Base, and Special Events drops of L2Attackable (called by calculateRewards).<BR><BR>
      *  
      ...
      * <li>If the autoLoot mode isn't active or if the L2Character that has killed the L2Attackable is not a L2PcInstance, add this or these Item(s) in the world as a visible object at the position where mob was last</li><BR><BR>
      * 
      * @param lastAttacker The L2Character that has killed the L2Attackable
      */
    ...
    {
        int actorLevel = caster.getLevel();
        double divisor = 0;

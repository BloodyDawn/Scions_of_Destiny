...
public abstract class BasePacket implements Cloneable
{
    ...
    protected BasePacket(MMOConnection con)
    {
        _connection = con;
    ...
    public BasePacket setConnection(MMOConnection con)
    {
        if (_connection == null)
        {
            _connection = con;
    ...
    public final MMOConnection getConnection()
    {
        return _connection;
    }
    ...
    public BasePacket duplicate(MMOConnection con)
    {
        try
        {

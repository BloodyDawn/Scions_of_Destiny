...
public class L2AttackableAI extends L2CharacterAI implements Runnable
{
    ...
    private boolean autoAttackCondition(L2Character target)
    {
        ...
        if (target.isAlikeDead() || !me.isInsideRadius(target, me.getAggroRange(), false, false) 
            || Math.abs(me.getZ() - target.getZ()) > 400)
            return false;
    ...
    private void thinkActive()
    {
        ...
        && !(_actor instanceof L2RaidBossInstance
           ...
           || _actor instanceof L2SepulcherMonsterInstance
           || npc.isQuestMonster()))
        {
            int x1, y1, z1;
    ...
    private void thinkAttack()
    {
        ...
        int combinedCollision = (int)(_actor.getTemplate().collisionRadius + _mostHatedAnalysis.character.getTemplate().collisionRadius);
        ...
        if ((dist2 > 310*310 + combinedCollision*combinedCollision) && this._selfAnalysis.hasLongRangeSkills

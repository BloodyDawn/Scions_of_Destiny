...
public class AdminSiege implements IAdminCommandHandler
{
    ...
    private static String[] _adminCommands =
    {
            ...
            "admin_setcastle", "admin_clanhall",
            "admin_clanhallset", "admin_clanhalldel",
	...
	int id = 0;        for (ClanHall clanhall: ClanHallManager.getInstance().getClanHalls())
        {
	    id++;	    if (id>15)	    {	replyMSG.append("</td><td>");
		id = 0;	    }            if (clanhall != null)
    ...
    public void showClanHallPage(L2PcInstance activeChar, ClanHall clanhall)
    {
        ...
        if (owner == null)        	replyMSG.append("ClanHall Owner: none<br><br>");
        else	    	    replyMSG.append("ClanHall Owner: " + owner.getName() + "<br><br>");

    ...
    public boolean useFood(L2PlayableInstance activeChar, int magicId, L2ItemInstance item)
    {
        ...
        if (skill != null)
        {
            if (activeChar instanceof L2PetInstance)
            {
                ...
                {
                    activeChar.broadcastPacket(new MagicSkillUser(activeChar, activeChar, magicId, 1, 0, 0));
            ...
            else if (activeChar instanceof L2PcInstance)
            {
                ...
                if (player.isMounted())
                {
                    ...
                    if (canUse)
                    {
                        ...
                        {
                            player.broadcastPacket(new MagicSkillUser(activeChar, activeChar, magicId, 1, 0, 0));

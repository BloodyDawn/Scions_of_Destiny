        ...
        # CLIENT EVENT ENABLE [N] #
          ...
          if event[2:].isdigit() :
            ...
            if event_id == 1 :
                ...
                if playerLevel == 5 :
                   if st.getInt("lvl") < 5 and st.getPlayer().getClassId().level() == 0:
                      if not st.getPlayer().getClassId().isMage() or classId == 49 :
                      ...
                      st.playSound("ItemSound.quest_tutorial")
                      st.set("lvl","5")
                elif playerLevel == 6 and st.getInt("lvl") < 6 and st.getPlayer().getClassId().level() == 0:
                   st.playTutorialVoice("tutorial_voice_020")
                   st.playSound("ItemSound.quest_tutorial")
                   st.showQuestionMark(24)
                   st.set("lvl","6")
                elif playerLevel == 7 and st.getPlayer().getClassId().isMage() and classId != 49:
                   if st.getInt("lvl") < 7 and st.getPlayer().getClassId().level() == 0:
                   ...
                   if st.getInt("lvl") < 19:
                      ...
                      if race != 5 and st.getPlayer().getClassId().level() == 0 :
                   ...
                   if st.getInt("lvl") < 35:
                      race = st.getPlayer().getRace().ordinal()
                      if race != 5 and st.getPlayer().getClassId().level() == 1 :
...
QUEST = Quest(255,"255_Tutorial","Tutorial")

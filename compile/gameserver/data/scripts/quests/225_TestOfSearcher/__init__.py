...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st) :
    ...
    if event == "7690-05.htm" :
        ...
        st.addSpawn(7628,10011,157449,-2374,300000)
        st.set("phase","20")
 ...
 def onKill (self,npc,player,isPet):
   st = player.getQuestState("225_TestOfSearcher")
   if st :
     ...
     if st.getInt(var)==status and count<maxcount and random<chance :
     ...
     if npcId==781 and random<30 and count<maxcount:
       st.addSpawn(5094,55841,176464,-2993,300000)

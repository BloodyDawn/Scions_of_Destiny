...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,st):
   ...
   if id == CREATED :
     ...
     st.set("onlyone","0")
     st.set("id","0")
   if npcId == 7106 and st.getInt("cond")==0 and st.getInt("onlyone")==0 :
     if st.getPlayer().getClassId().getId() in [ 0x07, 0x16, 0x23 ] :
       ...
       st.exitQuest(1)
   elif npcId == 7106 and st.getInt("cond")==0 and st.getInt("onlyone")==1 :
      htmltext = "<html><body>This quest has already been completed.</body></html>"
   elif npcId == 7106 and st.getInt("cond") == 1 and st.getInt("onlyone") == 0:
   ...
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(DUFNERS_LETTER_ID)==1 :
        htmltext = "7064-01.htm"
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(TERYS_ORDER1_ID)==1 :
      if st.getQuestItemsCount(MYSTERIOUS_RUNESTONE_ID) == 0 :
        htmltext = "7064-04.htm"
      else:
        htmltext = "7064-05.htm"
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(TERYS_ORDER2_ID)==1 :
   ...
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(TERYS_LETTER_ID)==1 :
      htmltext = "7064-11.htm"
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(VIKTORS_LETTER_ID)==1 :
      htmltext = "7064-12.htm"
      st.takeItems(VIKTORS_LETTER_ID,1)
      st.giveItems(HAWKEYES_LETTER_ID,1)
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(HAWKEYES_LETTER_ID)==1 :
      htmltext = "7064-13.htm"
   elif npcId == 7064 and st.getInt("cond")==1 and (st.getQuestItemsCount(VIKTORS_REQUEST_ID)==1 or st.getQuestItemsCount(ANALYSIS_REQUEST_ID)==1 or st.getQuestItemsCount(MARINAS_LETTER_ID)==1 or st.getQuestItemsCount(EXPERIMENT_TOOLS_ID)==1) :
      htmltext = "7064-14.htm"
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(ANALYSIS_RESULT_ID)==1 :
      htmltext = "7064-15.htm"
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(TERYS_ORDER3_ID)==1 :
      if st.getPlayer().getLevel()<36 :
   ...
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(LIST_OF_HOST_ID)==1 :
   ...
   elif npcId == 7064 and st.getInt("cond")==1 and st.getQuestItemsCount(TERYS_REPORT_ID)==1 :
      htmltext = "7064-24.htm"
   elif npcId == 7684 and st.getInt("cond")==1 and st.getQuestItemsCount(TERYS_LETTER_ID)==1 :
      htmltext = "7684-01.htm"
   elif npcId == 7684 and st.getInt("cond")==1 and st.getQuestItemsCount(HAWKEYES_LETTER_ID)==1 :
      htmltext = "7684-12.htm"
   elif npcId == 7684 and st.getInt("cond")==1 and st.getQuestItemsCount(VIKTORS_REQUEST_ID)==1 :
      if st.getQuestItemsCount(MEDUSAS_SCALES_ID)<10 :
        htmltext = "7684-13.htm"
      else:
        htmltext = "7684-14.htm"
   elif npcId == 7684 and st.getInt("cond")==1 and st.getQuestItemsCount(SILENS_RUNESTONE_ID)==1 and st.getQuestItemsCount(ANALYSIS_REQUEST_ID)==1 :
      htmltext = "7684-16.htm"
   elif npcId == 7684 and st.getInt("cond")==1 and (st.getQuestItemsCount(MARINAS_LETTER_ID)==1 and st.getQuestItemsCount(EXPERIMENT_TOOLS_ID)==1 and st.getQuestItemsCount(ANALYSIS_RESULT_ID)==1 and st.getQuestItemsCount(TERYS_REPORT_ID)==1) :
      htmltext = "7684-17.htm"
   elif npcId == 7715 and st.getInt("cond")==1 and st.getQuestItemsCount(SILENS_RUNESTONE_ID)==1 and st.getQuestItemsCount(ANALYSIS_REQUEST_ID)==1 :
      htmltext = "7715-01.htm"
   elif npcId == 7715 and st.getInt("cond")==1 and st.getQuestItemsCount(MARINAS_LETTER_ID)==1 :
      htmltext = "7715-03.htm"
   elif npcId == 7715 and st.getInt("cond")==1 and st.getQuestItemsCount(EXPERIMENT_TOOLS_ID)==1 :
      htmltext = "7715-04.htm"
   elif npcId == 7715 and st.getInt("cond")==1 and (st.getQuestItemsCount(ANALYSIS_RESULT_ID)==1 or st.getQuestItemsCount(TERYS_REPORT_ID)==1) :
      htmltext = "7715-06.htm"
   elif npcId == 7526 and st.getInt("cond")==1 and st.getQuestItemsCount(MARINAS_LETTER_ID)==1 :
      htmltext = "7526-01.htm"
      st.takeItems(MARINAS_LETTER_ID,1)
      st.giveItems(EXPERIMENT_TOOLS_ID,1)
   elif npcId == 7526 and st.getInt("cond")==1 and st.getQuestItemsCount(EXPERIMENT_TOOLS_ID)==1 :
      htmltext = "7526-02.htm"
   return htmltext

 def onKill (self,npc,player,isPet):
   st = player.getQuestState("213_TrialOfSeeker")
   if st :
...
QUEST.addTalkId(7064)
QUEST.addTalkId(7106)
QUEST.addTalkId(7526)
QUEST.addTalkId(7684)
QUEST.addTalkId(7715)
